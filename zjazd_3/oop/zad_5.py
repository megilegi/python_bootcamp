...
def test_withdraw_money_500():
    cash_machine = CashMachine()
    cash_machine.put_money([200, 100, 100, 50])
    assert cash_machine.withdraw_money(500) == []


def test_withdraw_money_next_step():
    cash_machine = CashMachine()
    cash_machine.put_money([200, 100, 100, 50])
    cash_machine.withdraw_money(500)
    assert cash_machine.is_available()

def test_withdraw_money_330():
    cash_machine = CashMachine()
    cash_machine.put_money([200, 100, 100, 50])
...
def test_withdraw_money_330():
    cash_machine = CashMachine()
    cash_machine.put_money([20, 20, 10, 50])
    assert cash_machine.withdraw_money(50) == [20, 20, 10]
